  ...
  return (
    <div className="flex justify-center items-center">
      <motion.div
        ...
        className={cn(
          "flex fixed top-1 md:top-2 inset-x-0 mx-6  border border-transparent dark:border-white/[0.2] dark:bg-[#080a23] bg-gray-700 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] z-[7000] px-8 py-2 items-center justify-between gap-1 rounded-md",
          className
        )}
      >
