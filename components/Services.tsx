          ...
          <div className='flex md:flex-1 justify-center items-center'>
                <div className='flex flex-col p-3 gap-4'>
                    ...
                    <div className='flex flex-col md:flex-row sm:flex-col gap-4 md:gap-2 sm:gap-4 justify-center items-center'>
                      <input placeholder='Name' type='text'  className='bg-blue-500 rounded-md h-[60] px-2 text-white w-full'/>
                      <input placeholder='Last Name' className='bg-blue-500 rounded-md h-[60] px-2 text-white w-full'/>
                    </div>

                    <div className='w-full'>
                      <input placeholder='Email'  type='email' className='bg-blue-500 rounded-md h-[60] w-full px-2 text-white'/>
                    </div>
